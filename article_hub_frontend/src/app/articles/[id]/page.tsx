...
export default function ArticleDetail() {
    ...
    const addComment = () => {
        addCommentApi({ articleId: id, content: content, userId: null }).then((data) => {
            getComments();
        })
    }
                                    ...
                                    {comments?.map((i) => (
                                        <div key={i.id} className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <span className="text-gray-600 text-sm mt-1 block">{format(i?.createdAt, 'MMMM dd, yyyy')}</span>
                                            </div>
                                        </div>
                                    ))}
                                </div>
